...
export default function CartSidebar() {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-full xs:w-[22rem] sm:w-96 bg-white z-50 shadow-2xl flex flex-col transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex-1 overflow-y-auto py-3 px-3 sm:py-4 sm:px-4">
          {cart.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center py-12">
              ...
              <p className="font-display font-semibold text-gray-500 text-base sm:text-lg">
                Cart is empty
              </p>
            ...
            <div className="space-y-2 sm:space-y-3">
              {cart.map((item) => (
                <div
                  key={item.productId}
                  className="flex gap-2 sm:gap-3 bg-gray-50 rounded-xl p-2.5 sm:p-3"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-navy-600 font-bold text-xs sm:text-sm">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <div className="flex items-center border border-gray-200 rounded-lg bg-white">
                        <button
                          ...
                          className="px-2 py-1 text-navy-700 hover:bg-navy-50 text-xs font-bold rounded-l-lg"
                        >
                          −
                        </button>
                        ...
                        <button
                          ...
                          className="px-2 py-1 text-navy-700 hover:bg-navy-50 text-xs font-bold rounded-r-lg"
                        >
                          +
                        </button>
                      </div>
